...
function M.new( instance )
    ...
    -- our character
    local sheetOptionsIdlejack = require("assets.spritesheets.jack.jackIdle")
    local sheetIdlejack = graphics.newImageSheet( "./assets/spritesheets/jack/jackIdle.png", sheetOptionsIdlejack:getSheet() )

    local sheetOptionsRunjack = require("assets.spritesheets.jack.jackRun")
    local sheetRunningjack = graphics.newImageSheet( "./assets/spritesheets/jack/jackRun.png", sheetOptionsRunjack:getSheet() )
    ...
    local sequence_data = {
        ...
        },
        {
            ...
            time = 1000,
            loopCount = 0,
            sheet = sheetRunningjack
        }
    }

    instance = display.newSprite( parent, sheetIdlejack, sequence_data )
